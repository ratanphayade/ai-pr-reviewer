...
export class Options {
  ...
  constructor(
    ...
    systemMessage = '',
    openaiLightModel = 'gpt-4-turbo',
    openaiHeavyModel = 'gpt-4-turbo',
    openaiModelTemperature = '0.0',
    openaiRetries = '2',
    openaiTimeoutMS = '120000',
    openaiConcurrencyLimit = '6',
    githubConcurrencyLimit = '6',
    apiBaseUrl = 'https://devproductivity-codereview.openai.azure.com/openai/deployments/CodeReviewerGPT4',
    language = 'en-US'
  ) {
    this.debug = debug
...
export class OpenAIOptions {
  ...
  constructor(model = 'gpt-4-turbo', tokenLimits: TokenLimits | null = null) {
    this.model = model
    if (tokenLimits != null) {
